...
=======
      ...
      var props = _objectWithoutProperties(_props, ["value", "error", "styles"]);
>>>>>>> hack: referencable from npm?
...
<<<<<<< HEAD
          _react2.default.createElement("input", _extends({}, props, { defaultValue: value, type: "text", className: className, onDrop: this._handleDrop })),
=======
